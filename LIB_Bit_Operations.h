...
/**************************************************************/
/*  5. Circular shifting operation:							    */
/*  operation -> Variable is shifted in the direction      		*/
/*							 specified, then OR-ed with the same variable	*/
/*							 shifted n-th places in the other direction 	*/
/*							 where n is the rest of the byte.							*/
/*  input 		-> Variable, bit number needed to change        */
/*  output		-> The new value of the variable after 					*/
/*   						 manipulation 																*/
/*  note 		  -> The macro doesn't store in the variable 			*/
/*							 itself so it expects a variable to store			*/
/*					 		 the result																		*/
/*  Example	  -> x = 0x81 --> x = CIRCULAR_SHIFT_LEFT(x,1)		*/
/*							 --> x = 0x03 																*/
/**************************************************************/

#define  CIRCULAR_SHIFT_LEFT(variable, value)\
(variable << value) | (variable >> (BYTE - value))

#define  CIRCULAR_SHIFT_RIGHT(variable, value)\
(variable >> value) | (variable << (BYTE - value))
/*============================================================*/
/*===============================================================*/
