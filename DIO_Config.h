...
/* -------------------------------> Port B <----------------------------------------*/
#define DIO_u8_PIN8_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN9_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN10_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN11_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN12_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN13_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN14_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN15_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT

/* -------------------------------> Port C <----------------------------------------*/
#define DIO_u8_PIN16_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN17_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN18_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN19_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN20_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN21_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN22_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN23_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT

/* -------------------------------> Port D <----------------------------------------*/
#define DIO_u8_PIN24_INIT_DIR	DIO_PIN_INIT_DIR_INPUT
#define DIO_u8_PIN25_INIT_DIR	DIO_PIN_INIT_DIR_INPUT
#define DIO_u8_PIN26_INIT_DIR	DIO_PIN_INIT_DIR_INPUT
#define DIO_u8_PIN27_INIT_DIR	DIO_PIN_INIT_DIR_INPUT
