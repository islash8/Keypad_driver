...
#define DIO_u8_PIN_OUTPUT 	(u8)1   /* ->This is used to set pin direction to output*/
#define DIO_u8_PIN_INPUT 	(u8)0	/* ->This is used to set pin direction to input */

#define DIO_u8_PIN_HIGH    (u8)1	/* -> This is used to set pin value to high     */
#define DIO_u8_PIN_LOW     (u8)0    /* -> This is used to set pin value to low      */

#define DIO_u8_PORT_OUTPUT (u8)0xFF/* ->This is used to set the whole port as output*/
#define DIO_u8_PORT_INPUT  (u8)0x00/* ->This is used to set the whole port as input */

#define DIO_u8_PORT_HIGH   (u8)0xFF/* -> This is used to set the whole port as high */
#define DIO_u8_PORT_LOW    (u8)0x00/* -> This is used to set the whole port as low  */
